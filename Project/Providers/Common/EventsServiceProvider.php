...
//                );
        ...
        $consumerConf->set('client.id', config('services.kafka.client_id', 'app-consumers-client'));
        $consumerConf->set('group.id', config('services.kafka.group_id', 'app-consumers-group'));
